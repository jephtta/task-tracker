    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm text-center space-y-8">
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-white">Task Tracker</h1>
        ...
        <div className="bg-[#111111] border border-[#222222] rounded-xl p-6 space-y-4">
          <p className="text-zinc-400 text-sm">Sign in to access your tasks</p>
          <Button
            onClick={handleSignIn}
            disabled={loading}
            className="w-full bg-white hover:bg-zinc-100 text-[#0a0a0a] font-medium transition-all duration-150"
          >
            {loading ? (
